...
import { studentPagePadding, eduPlanStatGridClass, eduPlanStatCardClass, registrationNavClass, registrationNavBtnClass } from '@/components/studentDetailResponsive';
    ...
    <>
      ...
      <ParentLayout user={user}>
        <div className={studentPagePadding}>
          <button onClick={() => router.push(`/parent/students/${studentId}`)} className="mb-3 inline-flex items-center text-sm text-gray-600 transition-colors hover:text-gray-900 sm:mb-6">
            ...
            <div className="mb-4 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm sm:mb-6">
              <div className={registrationNavClass}>
                {([
                  ...
                  { key: 'brainography' as ActiveView, label: 'Brainography' },
                  { key: 'portfolio' as ActiveView, label: 'Portfolio' },
                ...
                <button
                  onClick={() => router.push(`/parent/students/${studentId}/registration/${registrationId}/activity`)}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-4 lg:grid-cols-3 xl:grid-cols-5">
                    {dashboardStatCards.map((card) => {
                      ...
                      return (
                        <div key={card.title} className="rounded-xl border-2 border-gray-200 bg-white p-3 shadow-sm sm:p-5">
                          <div className="flex items-center justify-between">
