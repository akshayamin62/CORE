      ...
      <SuperAdminLayout user={currentUser}>
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="mb-6 md:mb-8">
            <h2 className="text-2xl font-bold text-gray-900 sm:text-3xl">Admin&apos;s Students</h2>
            <p className="mt-1 text-sm text-gray-600 sm:text-base">View students under this admin (read-only)</p>
          </div>
