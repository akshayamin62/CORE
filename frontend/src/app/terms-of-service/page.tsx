...
export const metadata: Metadata = {
  title: 'Terms of Service â€“ CORE by ADMITra',
  description: 'Terms of Service for CORE â€“ Student Application and Admission Management System by ADMITra.',
};
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-linear-to-br from-gray-900 via-purple-950 to-gray-900 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-purple-200 text-lg">CORE â€“ Student Application and Admission Management System</p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6 mb-6">
          <p className="text-purple-800 text-sm leading-relaxed">
            This Master Terms of Service ("Agreement") governs access to and use of CORE â€“ Student Application and Admission Management System ("CORE", "Platform"), operated by ADMITra ("Company", "we", "us", "our").
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-10 text-gray-700 leading-relaxed">
          ...
          <section id="section-9">
            ...
            <div className="space-y-5">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">9.1 India â€“ Digital Personal Data Protection Act, 2023</h3>
          ...
          <section id="section-12">
            ...
            <div className="space-y-4">
              {[
                {
                  title: 'Annexure A â€“ Student Terms',
                  items: [
                ...
                {
                  title: 'Annexure B â€“ Parent / Guardian Terms',
                  items: [
                ...
                {
                  title: 'Annexure C â€“ Counselor Terms',
                  items: [
                ...
                {
                  title: 'Annexure D â€“ Third-Party Service Provider Terms',
                  items: [
                ...
                {
                  title: 'Annexure E â€“ Agent Terms',
                  items: [
                ...
                {
                  title: 'Annexure F â€“ Advisor Terms',
                  items: [
