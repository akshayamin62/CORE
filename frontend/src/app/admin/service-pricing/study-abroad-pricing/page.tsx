      ...
      <div className="bg-gradient-to-b from-slate-50 via-white to-slate-50 min-h-[calc(100vh-5rem)]">
        <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white relative overflow-hidden">
          ...
          <div className="px-6 lg:px-8 py-8 relative">
            <button onClick={() => router.push('/admin/service-pricing')} className="mb-4 inline-flex items-center gap-1.5 text-sm text-blue-200 hover:text-white transition-colors font-medium">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
              Back to Service Pricing
            </button>
            <h1 className="text-2xl lg:text-3xl font-extrabold tracking-tight">Study Abroad Pricing</h1>
            <p className="text-blue-200 mt-1 max-w-2xl">Set the selling prices for your students&apos; Study Abroad plans.</p>
          </div>
        </div>
