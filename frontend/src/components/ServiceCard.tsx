          ...
          {isRegistered ? (
            ...
            <>
              ...
              <button
                onClick={() => onViewDetails?.(service._id)}
                disabled={loading}
                className="px-4 py-2 border-2 border-blue-600 text-blue-600 rounded-lg font-medium hover:bg-blue-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Learn More
              </button>
            </>
