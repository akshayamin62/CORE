        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            {classifyUniversity(program.university) === 'ivy-league' && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-sm font-semibold bg-red-600 text-white border border-green-200">
            ...
            {classifyUniversity(program.university) === 'russell-group' && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-sm font-semibold bg-purple-600 text-white border border-purple-200">
