  ...
  const navigationItems = [
    {
      ...
      path: isSuperAdmin ? '/super-admin/dashboard' : '/ops/dashboard',
    },
    {
      name: 'Students',
      icon: (
      ...
      path: isSuperAdmin ? '/super-admin/students' : '/ops/students',
    },
    {
      name: 'Services',
      icon: (
      ...
      path: isSuperAdmin ? '/super-admin/services' : '/ops/services',
    },
  ];
